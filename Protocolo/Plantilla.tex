...
\begin{document}
	...
	El cáncer de mama es una de las principales causas de mortalidad oncológica a nivel mundial. En 2024, el cáncer de mama fue la primera causa de muerte entre los tumores malignos en México (INEGI, 2025); 99.2 % ocurrieron en mujeres. Esta enfermedad es caracterizada por una heterogeneidad molecular, clínica y metabólica que complica su tratamiento y pronóstico. Una de las características distintivas de las células cancerosas es la reprogramación metabólica, un proceso mediante el cual estas células alteran su metabolismo para sostener la proliferación descontrolada, la supervivencia en condiciones adversas y la invasión tisular. Esta reprogramación implica cambios complejos en las redes de reacciones bioquímicas, las cuales pueden ser estudiadas desde la perspectiva de la biología de sistemas y la teoría de redes complejas.
