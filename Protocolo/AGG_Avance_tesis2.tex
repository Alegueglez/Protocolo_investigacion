...
% DATOS DEL DOCUMENTO
%-------------------------------------------------
\newcommand{\titulo}{Modelado multiescala de la red metabólica del cáncer de mama}
\newcommand{\subtitulo}{Redes complejas, dinámica no lineal y patrones de Turing}
\newcommand{\autor}{Alejandro Guerra González}
\newcommand{\asesor}{Dr. Erik César Herrera Hernández}
\newcommand{\institucion}{Universidad Autónoma de San Luis Potosí}
\newcommand{\facultad}{Facultad de Ciencias Químicas}
\newcommand{\programa}{Posgrado en Ciencias en Ingeniería Química}
...
\begin{document}
	...
	\begin{titlepage}
		\begin{center}
			...
			\begin{minipage}{0.25\textwidth}
				\centering
				\includegraphics[width=0.9\linewidth]{uaslp.png}
			\end{minipage}
			\hfill
			\begin{minipage}{0.25\textwidth}
				\centering
				\includegraphics[width=0.9\linewidth]{fcq.png}
			\end{minipage}
			
			\vspace{1.5cm}
			
			{\Large \textbf{\institucion}}\\[0.3cm]
			{\large \textbf{\facultad}}\\[0.3cm]
			{\large \programa}
	...
	El cáncer de mama es una enfermedad sistémica caracterizada por una profunda reprogramación metabólica, heterogeneidad intratumoral y alta capacidad de adaptación frente a perturbaciones terapéuticas. Según la Organización Mundial de la Salud, el cáncer representa la segunda causa de muerte a nivel mundial solo superada por los accidentes vasculares. Desde la Biología de Sistemas el cáncer se corresponde con un sistema dinámico que se auto-organiza fuera del equilibrio termodinámico mostrando una alta robustez y adaptabilidad. Dentro de los tipos de cancer mas comunes se encuentra el cáncer de mama.
	...
	\section{Redes complejas en biología de sistemas}
	Texto...
	
	\section{Comunidades metabólicas y modularidad}
	Texto...
	
	\section{Robustez estructural y dinámica}
	Texto...
	
	\section{Complejidad en sistemas dinámicos}
	Texto...
	
	\section{Red metabólica del cáncer de mama}
	Texto...
	...
	\begin{longtable}{c p{6cm} c c c p{3cm}}
		\caption{Cronograma de actividades del proyecto}\\
		\toprule
		\textbf{ID} & \textbf{Actividad} & \textbf{Inicio} & \textbf{Fin} & \textbf{Duración} & \textbf{Precedencia} \\
		\midrule
		\endfirsthead
